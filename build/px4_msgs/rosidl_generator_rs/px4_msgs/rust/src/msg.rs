...
impl EscReport {
    ...
    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR2: u8 = 102;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR3: u8 = 103;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR4: u8 = 104;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR5: u8 = 105;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR6: u8 = 106;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR7: u8 = 107;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR8: u8 = 108;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR9: u8 = 109;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR10: u8 = 110;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR11: u8 = 111;


    // This constant is not documented.
    #[allow(missing_docs)]
    pub const ACTUATOR_FUNCTION_MOTOR12: u8 = 112;
